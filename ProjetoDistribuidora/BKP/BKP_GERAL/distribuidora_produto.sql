...
CREATE TABLE `produto` (
  ...
  CONSTRAINT `FK_CATEGORIA_PRODUTO` FOREIGN KEY (`ID_CATEGORIA`) REFERENCES `categoria` (`IDCATEGORIA`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_FORNECEDOR_PRODUTO` FOREIGN KEY (`ID_FORNECEDOR`) REFERENCES `fornecedor` (`IDFORNECEDOR`) ON DELETE CASCADE ON UPDATE CASCADE
