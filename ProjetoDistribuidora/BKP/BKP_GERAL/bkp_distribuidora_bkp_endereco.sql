...
CREATE TABLE `bkp_endereco` (
  ...
  CONSTRAINT `FK_FORNECEDOR_CLIENTE` FOREIGN KEY (`ID_CLIENTE`) REFERENCES `bkp_cliente` (`IDCLIENTE`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_FORNECEDOR_ENDERECO` FOREIGN KEY (`ID_FORNECEDOR`) REFERENCES `bkp_fornecedor` (`IDFORNECEDOR`) ON DELETE CASCADE ON UPDATE CASCADE
